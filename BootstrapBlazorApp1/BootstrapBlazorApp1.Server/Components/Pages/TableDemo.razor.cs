...
namespace BootstrapBlazorApp1.Server.Components.Pages
{
    ...
    public partial class TableDemo : ComponentBase
    {
        ...
        private static IEnumerable<int> PageItemsSource => new int[] { 5, 10, 20, 40 };
        ...
        {
            FilenameStream = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "CCTable - Category vs SubCategory 20240426.xlsx");
            await fileViewer!.Reload(FilenameStream);
        }
    }
}
